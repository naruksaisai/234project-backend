...
WebUI.setText(findTestObject('Add items/Page_ProjectBackend/input_username'), username)

WebUI.setText(findTestObject('Add items/Page_ProjectBackend/input_password'), password)
