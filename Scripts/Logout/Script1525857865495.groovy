...
WebUI.setText(findTestObject('Logout/Page_ProjectBackend/input_username'), username)

WebUI.setText(findTestObject('Logout/Page_ProjectBackend/input_password'), password)
