...
WebUI.setText(findTestObject('Logout/Page_ProjectBackend/input_username'), 'user')

WebUI.setText(findTestObject('Logout/Page_ProjectBackend/input_password'), 'user')
